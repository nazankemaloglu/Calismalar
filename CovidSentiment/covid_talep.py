...
data1=pd.read_csv('/home/linux/İndirilenler/Tez-main/likoid/iki_data.csv')
...
labels = ('Request','Complaint','Praise','Question','Other')
...
model.compile(loss='categorical_crossentropy', 
             optimizer='adamax', 
             metrics=['accuracy'])
history=model.fit(X_train_seq_trunc,cat_ytrain, epochs=5,batch_size=256)
